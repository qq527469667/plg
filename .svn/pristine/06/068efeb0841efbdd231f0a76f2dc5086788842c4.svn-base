...
// 设置表单信息
function setOperate1(td, data, rowArr, row, col)
{
	$(td).html('<a href="javascript:;" class="btn btn-success me-table-view" table-data="' + row + '"><i class="icon-zoom-in "></i></a> \
			<a href="javascript:;" class="btn btn-info me-table-edit" table-data="' + row + '"><i class="icon-edit "></i></a>');
}
...
var oOperate1 = {"data": null, "title":"操作", "bSortable":false, "width":"120px", "createdCell":setOperate1};
...
var MeTable = (function($) {
	...
	MeTable.prototype.init = function() {
        ...
        {
        	$('#showTable_filter').html('<div id="searchExpand"></div><form action="post" id="searchForm">' + self.options.sSearchHtml + '</form>');
	...
	MeTable.prototype.initForm = function(data, isDetail)
	{
		...
		if ( ! isDetail) $(m).find('h4').html(this.options.sTitle + (this.actionType == "insert" ? "新增" : "编辑")); //标题
