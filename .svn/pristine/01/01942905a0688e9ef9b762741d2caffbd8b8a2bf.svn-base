...
class Page{
    ...
    private $config  = array(
        'header' => '<span class="rows pull-right p-10">共 <span class="text-danger">%TOTAL_ROW%</span> 条记录 <span class="text-primary">%NOW_PAGE%</span>/%TOTAL_PAGE% 页 </span>',
        'prev'   => '上一页',
        'next'   => '下一页',
        'first'  => '首页',
        // 'last'   => '...%TOTAL_PAGE%',
    ...
    public function show() {
        ...
        $page_str = str_replace(
            ...
            $this->config['theme']);
        // edited by liujx 2016-3-18 修改分页信息 start：
        // return "<di>{$page_str}</di>";
