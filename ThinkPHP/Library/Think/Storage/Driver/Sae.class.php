...
//              exit('请在SAE平台上运行代码。');
//        }
//        $this     Kv  =   @memcache_init();
//        if(!$this){
//Kv              header('Content-Type:text/html;charset=utf-8');
...
//        }
    ...
    public function put($filename,$content,$type=''){
        switch(strtolower($type)){
            ...
            default:
                $content    =   time().$content;
            /*if(!$this->setKv($filename,$content)){
        ...
        switch(strtolower($type)){
            ...
            default:
                if(!isset($this->contents[$filename])){
                    $this->contents[$filename] = $this->getKv($filename);
                }
